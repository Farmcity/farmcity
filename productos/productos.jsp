...
ResultSet rst;
String sql= new String("SELECT p.id_producto, p.clave_producto, p.descripcion, c.categoria , p.producto, p.precio, p.cantidad FROM \"farmacia\".productos p join \"farmacia\".categorias c on (p.id_categoria=c.id_categoria) order by id_producto");
          ...
          <div id="div_catalogos_productos_explander">
                <div align="center">
                	<table align="center" width="1000px">
                		<strong><p style="color:#081226; font-size:18px">CAT&Aacute;LOGO DE PRODUCTOS</p></strong>
                    </table>
                </div>
                <div>
